...
contract FractionalExponents  {
    ...
    uint8[256] private constant maxExpArray = [
        0x0,
        0x0,
        0x0,
        0x0,
    ...
    /**
        General Description:
            ...
            Calculate an integer approximation of _base ^ _exp.
    ...
    */
    function power(uint256 _base, uint32 _exp) public view returns (uint256, uint8) {
        assert(_base < MAX_NUM);

        uint256 baseLog;
        uint256 base = _base * FIXED_1;
        ...
        uint256 baseLogTimesExp = baseLog * _exp;
